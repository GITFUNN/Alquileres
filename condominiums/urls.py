...
urlpatterns = [
    ...
    path("create_private_file/<int:pk>/", views.create_private_file),
    path("create_private_image/<int:pk>/", views.create_private_image),
    path ("get_private_files/<int:pk>/", views.get_private_files),
]
