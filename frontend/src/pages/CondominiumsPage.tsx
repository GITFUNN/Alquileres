import {
  getCondominiumsRequest,
  deleteCondominiumRequest,
  getOwner,


} from "../api/condominium";
import {getUserAuthenticated} from "../api/user";
          ...
          >
            <div className="flex items-center">
              <span className="inline-block align-middle ml-2">
                <svg
                  className="h-4 w-4 fill-none stroke-2 stroke-violet-800"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  stroke-width="1.5"
                  stroke="currentColor"
            ...
            <div className="relative">
              <Link to={`${condominium.id}/`}>
                <span className="absolute right-1.5 bottom-1.5 ">
                  <svg
                    className="w-5 h-5 fill-none transition duration-150 hover:stroke-violet-800 "
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    stroke-width="1.5"
                    stroke="currentColor"
        ...
        <div className="text-center">
          <Link to="/create/">
            <span className="inline-block">
              <svg
                className="w-8 h-8 stroke-1 fill-none transition duration-150 hover:stroke-violet-800 "
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                stroke-width="1.5"
                stroke="currentColor"
