...
const CreateCondominiumPage = () => {
  ...
  const createMutation = useMutation({
    mutationFn: () =>
      createCondominiumRequest(condominium_name, condominium_location),
    onSuccess: () => {
              ...
              <div>
                ...
                <div className="flex items-center">
                  ...
                  <input
                    ...
                    className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg transition duration-50 block w-full p-1.5 sm:p-2 md:p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:ring-blue-500"
