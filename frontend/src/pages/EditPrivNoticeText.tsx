       ...
       <div className="px-4 py-6 space-y-4 ">
        ...
        <div className ='text-center' >
         ...
         <form className="space-y-4 " onSubmit={handleEditTextSubmit}>
           <div>
           <label htmlFor="email" className="block mb-2 text-sm font-medium text-black">Message</label>
