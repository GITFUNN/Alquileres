...
const UnitMgmt = ({ condId }: Props) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const enrichedData = await Promise.all(data?.map(async (apartment: Apartment) => {
  ...
  return (
    <div>
     ...
     <div className="">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 top-2 left-2 relative hover:bg-gray-100 rounded-lg cursor-pointer hover:stroke-violet-800" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" onClick={() => setShow(false)}>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" />
      ...
      <fieldset className="border-t border-black pb-4">
        <legend className="mx-auto px-4 text-xl">Apartments Section</legend>
    </fieldset>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M10.5 19.5 3 12m0 0 7.5-7.5M3 12h18" />
      ...
      {apartments.map((apartments) => (
         ...
         <div key={apartments.id} className="sm:py-1 sm:w-[600px] bg-white text-black my-6 sm:my-2 mx-auto border grid grid-rows-3 grid-flow-col grid-cols-2 rounded-lg border-slate-100 font-sans">
           

          
             <div className='flex items-center col-span-2'>
          <span className='inline-block align-middle ml-2'> 
         <svg className ="fill-none h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
  <path stroke-linecap="round" stroke-linejoin="round" d="M5.25 8.25h15m-16.5 7.5h15m-1.8-13.5-3.9 19.5m-2.1-19.5-3.9 19.5" />
           ...
           <p className="px-4 py-3">Number: {apartments.number}</p>
             ...
             <div className='flex items-center col-span-2'>
          <span className='inline-block align-middle ml-2'>
          <svg className="fill-none w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
...
<span className="absolute right-1.5 top-2 p-0.5 transition duration-150 hover:bg-gray-100 rounded-full hover:text-violet-800" title='Add Residents'>
<svg className="h-6 w-6 fill-none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
...
<svg className="w-8 h-8 stroke-1 fill-none transition duration-150 hover:stroke-violet-800 cursor-pointer" onClick={() => setShow(true)}  xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" >
